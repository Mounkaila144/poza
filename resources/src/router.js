...
const baseRoutes = [
    {
        ...
        children: [
            ...
            // TODO LIST
            {
                ...
                component: () =>
                    import(
                        /* webpackChunkName: "Todo" */ "./views/app/pages/todo"
                    ),
                redirect: "/app/Todo/Tasks",
                children: [
                    // Tasks
                    {
                        name: "Tasks",
                        ...
                        component: () =>
                            import(
                                /* webpackChunkName: "tasks" */ "./views/app/pages/todo/tasks"
                            )
                    },
                ]
            },
            ...
            // WAREHOUSE
            {
                ...
                component: () =>
                    import(
                        /* webpackChunkName: "warehouse" */ "./views/app/pages/warehouse"
                    ),
                redirect: "/app/warehouse/StockList",
                children: [
                    // StockList
                    {
                        name: "StockList",
                        ...
                        component: () =>
                            import(
                                /* webpackChunkName: "StockList" */ "./views/app/pages/warehouse/index_stocks"
                            )
                    },
                    // StockUpdate
                    {
                        ...
                        component: () =>
                            import(
                                /* webpackChunkName: "StockUpdate" */ "./views/app/pages/warehouse/update_stocks"
                            )
                    },
                     // StockList
                     {
                        ...
                        component: () =>
                            import(
                                /* webpackChunkName: "LowStock" */ "./views/app/pages/warehouse/index_low_stocks"
                            )
                    },
                ]
            },
              ...
              // PURCHASE SHIPMENT
              {
                ...
                path: "/app/purchase_shipments",
                component: () =>
                    import(
                        /* webpackChunkName: "purchase_shipment" */ "./views/app/pages/shipment/index_shipments.vue"
                    ),
              },
