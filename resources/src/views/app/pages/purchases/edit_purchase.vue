          ...
          <b-col lg="12" md="12" sm="12">
            <b-card>
              <b-row>
                ...
                <b-col lg="3" md="3" sm="12" class="mb-3">
                  <validation-provider name="expected_delivery_date" :rules="{ required: false }"
                    v-slot="validationContext">
                    <b-form-group :label="$t('expected_delivery_date')">
                      <b-form-input :state="getValidationState(validationContext)" aria-describedby="date-feedback"
                        type="date" v-model="purchase.expected_delivery_date"></b-form-input>
                ...
                <b-col md="12" class="mb-5">
                  ...
                  <div id="autocomplete" class="autocomplete">
                    ...
                    <ul class="autocomplete-result-list" v-show="focused">
                      <li class="autocomplete-result" v-for="(product_fil, i) in product_filter" :key="i"
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        <tr v-for="detail in details"
                          :class="{ 'row_deleted': detail.del === 1 || detail.no_unit === 0 }" :key="detail.detail_id">
                          ...
                          <td>
                            <span class="badge badge-outline-warning">{{ detail.stock }} {{ detail.unitPurchase
                              }}</span>
                          </td>
                          <td>
                            <div class="quantity">
                          ...
                          <td>{{ currentUser.currency }} {{ formatNumber(detail.DiscountNet * detail.quantity, 2) }}
                          </td>
      ...
      axios
        ...
        .then(response => {
          ...
          if (!this.purchase.warehouse_id) {
            this.purchase.warehouse_id = response.data.warehouses[0]?.id;
            setTimeout(() => {
