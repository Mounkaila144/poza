...
import IncommingPurchases from './incoming_purchases.vue';
import TodoTasks from './todo_tasks.vue';
import LatestAdjustments from './latest_adjustments.vue';
    ...
    all_dashboard_data() {
      ...
      axios
          ...
          .then(response => {
            ...
            this.adjustments = response.data.report_dashboard.original.last_adjustments;
            this.purchases = response.data.report_dashboard.original.pending_purchases ?? [];
