  ...
  <div class="side-content-wrap" @mouseenter="isMenuOver = true" @mouseleave="isMenuOver = false"
    ...
    && (currentUserPermissions.includes('products_add')
      ...
      || currentUserPermissions.includes('category'))" @mouseenter="toggleSubMenu" class="nav-item"
          ...
          <!-- WAREHOUSE -->
          <li v-show="currentUserPermissions && (currentUserPermissions.includes('stock_view')
    || currentUserPermissions.includes('stock_update'))" @mouseenter="toggleSubMenu" class="nav-item"
            :class="{ active: selectedParentMenu == 'warehouse' }" data-item="warehouse" :data-submenu="true">
            <a class="nav-item-hold" href="#">
...
<!--  -->
    ...
    || currentUserPermissions.includes('Quotations_add'))" @mouseenter="toggleSubMenu" class="nav-item"
            :class="{ active: selectedParentMenu == 'quotations' }" data-item="quotations" :data-submenu="true">
            <a class="nav-item-hold" href="#">
    ...
    || currentUserPermissions.includes('Purchases_add'))" @mouseenter="toggleSubMenu" class="nav-item"
            :class="{ active: selectedParentMenu == 'purchases' }" data-item="purchases" :data-submenu="true">
            <a class="nav-item-hold" href="#">
          ...
          <li v-show="currentUserPermissions && (currentUserPermissions.includes('Purchases_view')
    || currentUserPermissions.includes('Purchases_add'))" @mouseenter="() => toggleSubMenu()" :class="{ active: selectedParentMenu == 'purchase_shipment' }" class="nav-item"
            data-item="purchase_shipment">
            <router-link tag="a" class="nav-item-hold" to="/app/purchase_shipments">
              <i class="nav-icon i-Truck"></i>
              <span class="nav-text">{{ $t("purchase_shipments") }}</span>
            </router-link>
          </li>
  ...
  )" @mouseenter="toggleSubMenu" :class="{ active: selectedParentMenu == 'hrm' }" class="nav-item" data-item="hrm"
            :data-submenu="true">
            <a class="nav-item-hold" href="#">
  ...
  )" @mouseenter="toggleSubMenu" class="nav-item" :class="{ active: selectedParentMenu == 'accounting' }"
            data-item="accounting" :data-submenu="true">
            <a class="nav-item-hold" href="#">
    ...
    || currentUserPermissions.includes('users_view'))" @mouseenter="toggleSubMenu"
          ...
          <!-- TODO -->
          <li v-show="currentUserPermissions && (currentUserPermissions.includes('todo_task_view')
    || currentUserPermissions.includes('todo_task_add'))" @mouseenter="toggleSubMenu" class="nav-item"
            :class="{ active: selectedParentMenu == 'todo' }" data-item="Todo" :data-submenu="true">
            <a class="nav-item-hold" href="#">
              <i class="nav-icon i-Checkout-Basket"></i>
              <span class="nav-text">{{ $t('Todos') }}</span>
            </a>
            <div class="triangle"></div>
          </li>
          ...
          <li v-for="ComponentModule in getallmodules"
            ...
            @mouseenter="toggleSubMenu" class="nav-item">
    ...
    <vue-perfect-scrollbar :class="{ open: getSideBarToggleProperties.isSecondarySideNavOpen }"
      ...
      <div ref="sidebarChild">
        <ul class="childNav d-none" data-parent="products" :class="{ 'd-block': selectedParentMenu == 'products' }">
          ...
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('count_stock')">
        ...
        <ul class="childNav d-none" data-parent="accounting" :class="{ 'd-block': selectedParentMenu == 'accounting' }">

          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('account')">
          ...
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('transfer_money')">
          ...
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('deposit_add')">
            <router-link tag="a" class to="/app/deposits/store">
              <i class="nav-icon i-Add-File"></i>
              <span class="item-name">{{ $t('Create_deposit') }}</span>
            </router-link>
          </li>
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('deposit_view')">
        ...
        <ul class="childNav d-none" data-parent="hrm" :class="{ 'd-block': selectedParentMenu == 'hrm' }">
          ...
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('payroll')">
        ...
        <!-- Todo -->
        <ul class="childNav d-none" data-parent="Todo" :class="{ 'd-block': selectedParentMenu == 'Todo' }">
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('todo_task_view')">
            <router-link tag="a" class to="/app/Todo/Tasks">
              <i class="nav-icon i-Files"></i>
              <span class="item-name">{{ $t('Tasks') }}</span>
            </router-link>
          </li>
        </ul>
        <!--  -->
        ...
        <!-- WAREHOUSE -->
        <ul class="childNav d-none" data-parent="warehouse" :class="{ 'd-block': selectedParentMenu == 'warehouse' }">
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('stock_view')">
            <router-link tag="a" class to="/app/Warehouse/StockList">
              <i class="nav-icon i-Files"></i>
              <span class="item-name">{{ $t('Stock_List') }}</span>
            </router-link>
          </li>
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('stock_update')">
            <router-link tag="a" class to="/app/Warehouse/StockUpdate">
              <i class="nav-icon i-Remove-File"></i>
              <span class="item-name">{{ $t('Stock_Update') }}</span>
            </router-link>
          </li>
        ...
        <ul class="childNav d-none" data-parent="settings" :class="{ 'd-block': selectedParentMenu == 'settings' }">
          ...
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('module_settings')">
    ...
    (currentUserPermissions.includes('Reports_payments_Purchases')
      ...
      || currentUserPermissions.includes('Reports_payments_purchase_Return'))"
          ...
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('inventory_valuation')">
          ...
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('expenses_report')">
          ...
          <li class="nav-item" v-if="currentUserPermissions && currentUserPermissions.includes('deposits_report')">
