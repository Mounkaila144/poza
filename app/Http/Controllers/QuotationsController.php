        ...
        foreach ($Quotation['details'] as $detail) {
            ...
            if ($detail->product_variant_id) {
                ...
                if (isset($detail['product'])) {
                    ...
                    $data['code'] = 'SERVICE';
                    $data['name'] = $detail['description'] ?? 'Description';
                }
            }
            ...
            $data['subtotal'] = number_format($detail->quantity * $detail->price, 2, '.', '');
