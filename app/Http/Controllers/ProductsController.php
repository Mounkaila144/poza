...
class ProductsController extends BaseController
{
    ...
    public function lowStockIndex(request $request)
    {
        ...
        $products = product_warehouse::with('warehouse', 'product', 'product.unit', 'product.category', 'product.brand', 'productVariant')
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $productRules = [
                'warehouse_id' => 'required|exists:warehouses,id', // Validation pour spécifier un entrepôt
                'code'         => [
                    'required',
            ...
            \DB::transaction(function () use ($request) {
                ...
                //-- Field Required
                $Product->show_alert         = $request['show_alert'];
                ...
                $Product->show_alert = $request['show_alert'] == 'true' ? 1 : 0;
                ...
                $warehouse_id = $request->warehouse_id; // L'entrepôt spécifié dans la requête
                ...
                if ($request['is_variant'] == 'true') {
                    ...
                    foreach ($Product_variants as $product_variant) {
                        $product_warehouse[] = [
                            'product_id'         => $Product->id,
                            'warehouse_id'       => $warehouse_id, // Associer au warehouse spécifié
