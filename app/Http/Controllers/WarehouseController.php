...
class WarehouseController extends Controller
{
    ...
    public function destroy(Request $request, $id)
    {
        ...
        // Démarrer une transaction pour s'assurer de la cohérence des opérations
        \DB::transaction(function () use ($id) {

            // Suppression physique des produits associés dans la table product_warehouse
            product_warehouse::where('warehouse_id', $id)->delete();

            // Suppression physique de l'entrepôt
            Warehouse::where('id', $id)->delete();

        }, 10); // 10 est le nombre maximum de tentatives si un conflit survient dans la transaction
