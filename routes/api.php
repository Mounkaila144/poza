...
Route::middleware(['auth:api', 'Is_Active'])->group(function () {
   ...
   // Route::post('attendance_by_employee/{id}', 'hrm\EmployeeSessionController@attendance_by_employee')->name('attendance_by_employee.post');
    ...
    //  --- LOW STOCK
    Route::get('products/stock/low', 'ProductsController@lowStockIndex');
    ...
    // Route::get('get_sub_units_by_base', 'TaskController@Get_Units_SubBase');
    // Route::get('get_units', 'TaskController@Get_sales_units');

    //------------------------------- PURCHASE - SHPMENT --------------------------\\
    //------------------------------------------------------------------\\

    Route::resource('purchase_shiments', 'PurchaseShipmentController');
